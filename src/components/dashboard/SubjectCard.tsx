...
export default function SubjectCard({ title, description, progress, icon, color, onClick }: SubjectCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="group flex min-h-[210px] min-w-[260px] flex-col rounded-3xl border border-white/12 bg-[rgba(10,23,52,0.74)] p-6 text-left shadow-[inset_0_0_40px_rgba(255,255,255,0.025)] backdrop-blur-2xl transition-all duration-300 hover:-translate-y-1.5 hover:border-[#00C8FF]/45 hover:bg-[rgba(22,43,92,0.9)] hover:shadow-[0_18px_44px_rgba(0,200,255,0.18)] lg:min-w-0"
    >
